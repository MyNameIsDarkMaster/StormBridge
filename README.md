...
- [Инструкция по эксплуатации в Linux](#инструкция-по-эксплуатации-в-linux)
...
Возможность работы с низковольтными (от 1.2в) интерфейсами с автоматическим или принудительным определением вольтажа обмена__
Реализована отключаемая гальваническая изоляция UART__
