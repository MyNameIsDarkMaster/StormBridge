...
- Разъем может активироваться от фантомного питания, через пины RX-TX с внешней стороны и даже передавать информация с поднятым переключателем SW:4. Корректная работа в таком режиме не может быть гарантирована.
